    				...
    				# show gps on frame
                                    while(True):
                                        ...
                                        if "GPRMC" in data[0]:
                                            ...
                                            cv2.putText(frame, data[3]+data[4], (280,20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, [0,255,255], 1)
                                            cv2.putText(frame, data[5]+data[6], (280,35), cv2.FONT_HERSHEY_SIMPLEX, 0.5, [0,255,255], 1)
                                            break
                                    #cv2.imwrite('./images/'+str(time.ctime())+'.jpg',frame)
    
    
            cv2.putText(frame, str(round(1/(time.time() - timeCur),2))+' fps', (20,20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, [0,255,255], 1)
